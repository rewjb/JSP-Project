	...
	<center>
		...
		<table id="table" width="1000" border="1">
			...
			<tr>
				...
				<form method="post" action="memberInfoUpdate.jsp" id="joinInfo" onsubmit="return finalCheck()"
					class="needs-validation" novalidate>

					<td align="left" valign="top"><br>
						<div align="center">
							<span class="badge badge-secondary"><font size="5">회원정보 수정</font></span>
						</div>
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<!-- 회원가입 아이디 입력란 -->
							<input type="text" class="form-control" id="inputId" disabled="disabled"
								name="id" placeholder="아이디를 입력하세요." value="<%=memberDTO.getId()%>"
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<input id="inputPw" type="password" class="form-control" oninput="checkInputPw();"  value="<%=memberDTO.getPw()%>"
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<input id="reInputPw" name="pw" type="password" class="form-control"  oninput="checkInputPw();" disabled="disabled"
								placeholder="비밀번호 재확인을 입력하세요." style="margin-right: 350px" maxlength="15" value="<%=memberDTO.getPw()%>"
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<input id="InputName" name="name" type="text" class="form-control" placeholder="이름을 입력하세요." oninput="checkInputName();" value="<%=memberDTO.getName()%>"
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<input id="InputDate" name="birthDay" type="date" class="form-control" oninput="checkInputDate();" disabled="disabled"
								placeholder="생년월일 입력 하세요." style="margin-right: 350px" maxlength="10" value="<%=memberDTO.getBirthDay()%>"
								aria-describedby="basic-addon3">
						</div>
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<input id="InputTel" name="tel" type="text" class="form-control" oninput="checkInputTel();" placeholder="'-' 없이 입력해 주세요" value="<%=memberDTO.getTel()%>"
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<input id="totalAddr"  name="addr" type="text" class="form-control"  placeholder="'-' 없이 입력해 주세요" value="<%=memberDTO.getAddr()%>" onkeyup="checkInputAddr();"
							maxlength="60" style="margin-right: 350px" aria-describedby="basic-addon3">
						</div>
						...
						<div class="input-group mb-3" style="margin-left: 150px">
							...
							<input type="email" class="form-control" id="InputEmail" name="email" maxlength="60" oninput="checkInputEmail();" value="<%=memberDTO.getEmail()%>"
								style="margin-right: 500px" aria-describedby="basic-addon3" disabled="disabled">
						</div>
						...
						<div class="btn-group" >
							...
							<input type="submit" class="btn btn-dark" value="수정하기" 
								...
								<A href="/JSPproject/client/dropOutPerform.jsp?id=<%=session.getAttribute("id") %>>"><button class="btn btn-dark">탈퇴하기</button></A></div>
	...
	<script type="text/javascript">
							...
							new daum.Postcode(
									{
										oncomplete : function(data) {
											...
											if (data.userSelectedType === 'R') {
												...
												document
														.getElementById("totalAddr").value = extraAddr;

											} else {
												document
														.getElementById("totalAddr").value = '';
											}

											// 우편번호와 주소 정보를 해당 필드에 넣는다.
											document
													.getElementById('totalAddr').value = data.zonecode;
											document
													.getElementById("totalAddr").value = addr;
											// 커서를 상세주소 필드로 이동한다.
					...
					//유효성을 검사하는 자바스크립트
		               ...
		               var emailCheck = false;
	                    ...
	                    function finalCheck() {
	                    	//마지막 보내기전 유효성 검사
	                    	 if( pwCheck == true && nameCheck == true  &&  telCheck == true && placeCheck == true) {	                    		 return true;
	                    		  }else{
