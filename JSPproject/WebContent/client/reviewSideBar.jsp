    ...
    %>
        <div class="col-xs-6 col-xs-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group"> 
            <a style="FONT-SIZE: 10pt" href="productDetail2.jsp?center=reviewTotal.jsp&pid=<%=pid %>&mid=<%=mid %>"
            class="list-group-item  ${ param.center=='reviewTotal.jsp'? 'active' : ''}">전체보기</a>
            <a style="FONT-SIZE: 10pt" href="productDetail2.jsp?center=reviewGradeList.jsp&pid=<%=pid %>&mid=<%=mid %>"
            ...
            <a style="FONT-SIZE: 10pt" href="productDetail2.jsp?center=QnATotal.jsp&pid=<%=pid %>&id=<%=mid %>"
