...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	function checkLog(){
		<%if(session.getAttribute("mid") == null){%>
			...
			document.location.href="productdetail2.jsp?center=reviewGradeList.jsp";
		<%}%>			
	}
	</script>
  			...
  			<div class="jumbotron">         
				    <%
         				    	int prev; //이전
         				             				    		    ...
         				             				    		    count =rdao.getAllGradeCount(pid);
         				             				    			
         				             				    		    //현재 페이지에 보여줄 시작 번호를 설정 = 데이터 베이스에서 불러올 시작번호
         				             				    		    int startRow =(currentPage-1) *pageSize+1;
         				             				    		    int endRow =currentPage * pageSize;
         				             				    		    
         				             				    			Vector<ReviewBean> vec = rdao.getGradeReview(pid, startRow, endRow);
         				             				    			 //테이블에 표시할 번호를 지정
													  ...
													  <ul class="pagination pagination-xs">
													    <li>
													    	<%       
																...
																prev =startPage-10;       
															%>
													      <a href="productDetail2.jsp?center=reviewGradeList.jsp?pageNum=<%=prev%>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
													    </li>
													    <%
													    	}
															 //페이징 처리
														...
														%>
													    <li<% if(i == startRow );%>><a class="page-link" href="productDetail2.jsp?center=reviewGradeList.jsp?pageNum=<%=i%>"><%=i%></a></li>
													    <%        
														     }    
														     //다음 이라는 링크를 만들건지 파악
														  ...
														  %>  
													    <li>
													      <a href="productDetail2.jsp?center=reviewGradeList.jsp?pageNum=<%=next%>" aria-label="Next">
